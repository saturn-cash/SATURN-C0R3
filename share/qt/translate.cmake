...
function(extract_strings output)
  ...
  file(STRINGS "saturnstrings.po" text ENCODING "UTF-8")
...
static const char UNUSED *saturn_strings[] = {
  ...
  set(prefix "QT_TRANSLATE_NOOP(\"saturn-core\", \"")
  set(suffix "\"),\n")
...
extract_strings("${PROJECT_SOURCE_DIR}/src/qt/saturnstrings.cpp"
...
execute_process(
  COMMAND ${LUPDATE_EXECUTABLE}
    ...
    ${PROJECT_SOURCE_DIR}/src/qt/saturnstrings.cpp
    -ts ${PROJECT_SOURCE_DIR}/src/qt/locale/saturn_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)
...
execute_process(
  COMMAND ${LCONVERT_EXECUTABLE}
    -drop-translations
    -o ${PROJECT_SOURCE_DIR}/src/qt/locale/saturn_en.xlf
    -i ${PROJECT_SOURCE_DIR}/src/qt/locale/saturn_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)

file(READ "${PROJECT_SOURCE_DIR}/src/qt/locale/saturn_en.xlf" saturn_en)
string(REPLACE "source-language=\"en\" target-language=\"en\""
  "source-language=\"en\"" saturn_en "${saturn_en}"
)
string(REGEX REPLACE " *<target xml:space=\"preserve\"></target>\n"
  "" saturn_en "${saturn_en}"
)
file(WRITE "${PROJECT_SOURCE_DIR}/src/qt/locale/saturn_en.xlf" "${saturn_en}")
