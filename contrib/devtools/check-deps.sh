...
declare -A LIBS
LIBS[cli]="libsaturn_cli.a"
LIBS[common]="libsaturn_common.a"
LIBS[consensus]="libsaturn_consensus.a"
LIBS[crypto]="libsaturn_crypto.a"
LIBS[node]="libsaturn_node.a"
LIBS[util]="libsaturn_util.a"
LIBS[wallet]="libsaturn_wallet.a"
...
# https://github.com/saturn/saturn/issues/10102
