...
BITCOIND=${BITCOIND:-$BINDIR/saturnd}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/saturn.conf}
...
then
  ...
  echo -e "To safely generate a saturn.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example saturn.conf file in share/examples/'
...
## Generated by contrib/devtools/gen-saturn.conf.sh.
##
...
# parse the output from saturnd --help
