...
"""Example logging Saturn Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py <pid of saturnd>
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[saturnd_with_usdts])
