...
complete --command saturn-qt --no-files

# Extract options
function __fish_saturnqt_get_options
...
complete \
    --command saturn-qt \
    --arguments "(__fish_saturnqt_get_options --nofiles)"
