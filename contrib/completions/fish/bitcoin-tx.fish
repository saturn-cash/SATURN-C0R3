...
# Extract options
function __fish_saturn_tx_get_options
...
# Extract commands
function __fish_saturn_tx_get_commands
...
complete \
    --command saturn-tx \
    --condition "not __fish_saturn_seen_cmd (__fish_saturn_tx_get_commands --commandsonly)" \
    --arguments "(__fish_saturn_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command saturn-tx \
    --arguments "(__fish_saturn_tx_get_commands)" \
    --no-files
