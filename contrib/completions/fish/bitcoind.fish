...
complete --command saturnd --no-files

# Extract options
function __fish_saturnd_get_options
...
complete \
    --command saturnd \
    --arguments "(__fish_saturnd_get_options --nofiles)"
