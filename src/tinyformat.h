...
#include <algorithm>
#include <attributes.h> // Added for Saturn Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Saturn Core
#include <util/string.h> // Added for Saturn Core
...
// Added for Saturn Core. Similar to std::runtime_format from C++26.
...
// Added for Saturn Core. Wrapper for checking format strings at compile time.
