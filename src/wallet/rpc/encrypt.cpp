...
RPCMethod walletpassphrase()
{
    return RPCMethod{
        ...
        "Stores the wallet decryption key in memory for 'timeout' seconds.\n"
                "This is needed prior to performing transactions related to private keys such as sending saturns\n"
            "\nNote:\n"
...
RPCMethod encryptwallet()
{
    return RPCMethod{
        ...
        "will require the passphrase to be set prior to making these calls.\n"
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending saturn\n"
