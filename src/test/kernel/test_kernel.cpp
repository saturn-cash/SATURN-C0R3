// Copyright (c) 2024-present The Saturn Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#include <kernel/saturnkernel.h>
#include <kernel/saturnkernel_wrapper.h>
#include <util/fs.h>

#define BOOST_TEST_MODULE Saturn Kernel Test Suite
...
{
    Logger logger{std::make_unique<TestLog>()};
    auto test_directory{TestDirectory{"chainman_test_saturn_kernel"}};
...
{
    auto test_directory{TestDirectory{"mainnet_test_saturn_kernel"}};
...
{
    auto test_directory{TestDirectory{"block_tree_entry_test_saturn_kernel"}};
    auto notifications{std::make_shared<TestKernelNotifications>()};
...
{
    auto in_memory_test_directory{TestDirectory{"in-memory_test_saturn_kernel"}};
...
{
    auto test_directory{TestDirectory{"regtest_test_saturn_kernel"}};
