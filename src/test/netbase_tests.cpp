...
{
    BOOST_CHECK(TestSplitHost("www.saturncore.org", "www.saturncore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.saturncore.org]", "www.saturncore.org", 0));
    BOOST_CHECK(TestSplitHost("www.saturncore.org:80", "www.saturncore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.saturncore.org]:80", "www.saturncore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.saturncore.org:65536", "www.saturncore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.saturncore.org:0", "www.saturncore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.saturncore.org:", "www.saturncore.org:", 0, false));
}
