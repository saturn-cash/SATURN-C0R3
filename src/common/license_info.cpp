...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure Saturn Core copyright is not removed by accident
    if (copyright_devs.find("Saturn Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Saturn Core developers";
    }
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/saturn/saturn>";
