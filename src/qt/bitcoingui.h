...
/**
  Saturn GUI main class. This class represents the main window of the Saturn UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class SaturnGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit SaturnGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~SaturnGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a saturn wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, SaturnUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Saturn Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(SaturnUnit newUnits);
