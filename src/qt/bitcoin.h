...
/** Main Saturn application object */
class SaturnApplication: public QApplication
{
    Q_OBJECT
public:
    explicit SaturnApplication();
    ~SaturnApplication();
    ...
    /// Get window identifier of QMainWindow (SaturnGUI)
...
Q_SIGNALS:
    ...
    void windowShown(SaturnGUI* window);
