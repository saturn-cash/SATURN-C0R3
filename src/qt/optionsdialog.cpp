      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->saturnAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->saturnAtStartup);
    ...
    ui->saturnAtStartup->setToolTip(ui->saturnAtStartup->toolTip().arg(CLIENT_NAME));
    ui->saturnAtStartup->setText(ui->saturnAtStartup->text().arg(CLIENT_NAME));

    ui->openSaturnConfButton->setToolTip(ui->openSaturnConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new SaturnUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->saturnAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSSATontrols);
...
void OptionsDialog::on_openSaturnConfButton_clicked()
{
