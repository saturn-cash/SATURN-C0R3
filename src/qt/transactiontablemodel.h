...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, SaturnUnits::SeparatorStyle separators=SaturnUnits::SeparatorStyle::STANDARD) const;
