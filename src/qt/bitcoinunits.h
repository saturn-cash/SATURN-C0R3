...
/** Saturn unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SaturnUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SaturnUnits(QObject *parent);

    /** Saturn units.
      @note Source: https://en.saturn.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        SAT,
        mSAT,
...
typedef SaturnUnits::Unit SaturnUnit;
