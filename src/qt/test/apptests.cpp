...
//! Entry point for SaturnApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &SaturnApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for SaturnGUI tests.
void AppTests::guiTests(SaturnGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &SaturnGUI::consoleShown, this, &AppTests::consoleTests);
