...
extern thread_local ThreadContext g_thread_context; // NOLINT(saturn-nontrivial-threadlocal)
// Silence nonstandard saturn tidy error "Variable with non-trivial destructor
