...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the SaturnTestFramework
    pass


class ExampleTest(SaturnTestFramework):
    # Each functional test is a subclass of the SaturnTestFramework class.
    ...
    def custom_method(self):
        ...
        SaturnTestFramework class so other tests can use it."""
