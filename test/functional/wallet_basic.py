...
class WalletTest(SaturnTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 SAT from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 SAT with subtract fee from amount
        ...
        # Sendmany 10 SAT with subtract fee from amount
        ...
        # Sendmany 5 SAT to two addresses with subtracting fee from both addresses
