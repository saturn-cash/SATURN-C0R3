...
By default, saturnd will dump mempool on shutdown and
...
class MempoolPersistTest(SaturnTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent saturnd from writing mempool.dat to disk. Verify that `savemempool` fails")
