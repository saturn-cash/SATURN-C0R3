...
Verify that a saturnd node can use an external signer command.
...
class RPCSignerTest(SaturnTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart saturnd with -signer=<cmd>',
