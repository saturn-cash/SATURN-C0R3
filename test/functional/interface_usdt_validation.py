...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/saturn/saturn/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(SaturnTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/saturn/saturn/blob/master/doc/tracing.md#tracepoint-validationblock_connected
