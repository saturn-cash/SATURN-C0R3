...
# TestP2PConn: A peer we use to send messages to saturnd, and store responses.
...
class CompactBlocksTest(SaturnTestFramework):
    ...
    # This test actually causes saturnd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that saturnd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for saturnd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # saturnd will not send blocktxn responses for blocks whose height is
