...
class TestShell:
    """Wrapper Class for SaturnTestFramework.

    The TestShell class extends the SaturnTestFramework
    ...
    class __TestShell(SaturnTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by SaturnTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # SaturnTestFramework instances are supposed to be constructed with the path
