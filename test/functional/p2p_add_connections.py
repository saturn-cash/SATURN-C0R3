...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The saturnd node closes feeler connections as soon as a version
...
class P2PAddConnections(SaturnTestFramework):
    ...
    def run_test(self):
        ...
        # saturnd behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that saturnd sends its own version prior to processing
