...
"""Verify that starting saturn with -h works as expected."""

from test_framework.test_framework import SaturnTestFramework
from test_framework.util import assert_equal

class HelpTest(SaturnTestFramework):
    ...
    def run_test(self):
        self.log.info("Start saturn with -h for help text")
        ...
        self.log.info("Start saturn with -version for version information")
        ...
        self.log.info("Start saturnd with -fakearg to make sure it does not start")
