...
class TxnMallTest(SaturnTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 SAT:
        ...
        # First: use raw transaction API to send 1240 SAT to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 SAT coin each
        ...
        # Node0's balance should be starting balance, plus 50SAT for another
        ...
        # Node0's total balance should be starting balance, plus 100SAT for
