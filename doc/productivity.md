...
```sh
cmake --build build --target saturnd saturn-cli
cmake --build build --target saturn-qt
cmake --build build --target bench_saturn
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:saturn/saturn.git
```
...
> e.g. github.com/saturn/saturn.git or for the GUI github.com/saturn-core/gui
