...
The Saturn Core daemon can be configured to act as a trusted "border
router", implementing the saturn wire protocol and relay, making
...
The ZeroMQ feature in Saturn Core requires the ZeroMQ API >= 4.0.0
...
For instance:
    ...
    $ saturnd -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubhashtx=tcp://192.168.1.2:28332 \
               -zmqpubhashblock="tcp://[::1]:28333" \
               -zmqpubrawtx=unix:/tmp/saturnd.tx.raw \
...
From the perspective of saturnd, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into saturnd directly. Furthermore, no information is
...
using. Saturnd appends an up-counting sequence number to each
