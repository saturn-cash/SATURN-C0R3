# PSBT Howto for Saturn Core

Since Saturn Core 0.17, an RPC interface exists for Partially Signed Saturn
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/saturn/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for Saturn transactions that are not fully signed
...
#### Multisig with multiple Saturn Core instances
