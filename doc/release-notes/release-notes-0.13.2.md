Saturn Core version 0.13.2 is now available from:

  <https://saturn.org/bin/saturn-core-0.13.2/>
...
- #8908 `4a974b2` Update saturn-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow saturn-tx to create v2 transactions (btcdrak)
