Saturn-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/saturn/files/Saturn/saturn-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Saturn
...
New/changed settings (command-line or saturn.conf file)
--------------------------------------------------------
