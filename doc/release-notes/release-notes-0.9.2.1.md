Saturn Core version 0.9.2.1 is now available from:

  https://saturn.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 SAT to 0.01 SAT
...
- Fix "Start saturn on system login"
