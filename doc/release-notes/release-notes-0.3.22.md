Download URL: https://sourceforge.net/projects/saturn/files/Saturn/saturn-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 SAT fee schedule (users still pay 0.01 SAT per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #saturn00 - #saturn99
