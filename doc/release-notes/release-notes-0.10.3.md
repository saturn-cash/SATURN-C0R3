Saturn Core version 0.10.3 is now available from:

  <https://saturn.org/bin/saturn-core-0.10.3/>
...
(see https://github.com/saturn/saturn/pull/6793, as well as the 0.11.0
