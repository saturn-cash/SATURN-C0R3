Saturn Core version 0.16.1 is now available from:

  <https://saturncore.org/bin/saturn-core-0.16.1/>
...
- #12843 `df38b13` Test starting saturnd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure saturnd processes are cleaned up when tests end (sdaftuar)
