Saturn version 0.5.4 is now available for download at:
http://sourceforge.net/projects/saturn/files/Saturn/saturn-0.5.4/
...
http://gitorious.org/saturn/saturnd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Saturn-Qt notifications under Growl 1.3.
Increase required age of Saturn-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxSaturn properly when installing Saturn-Qt over it. (Windows)
