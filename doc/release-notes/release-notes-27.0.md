Saturn Core version 27.0 is now available from:

  <https://saturncore.org/bin/saturn-core-27.0/>
...
- libsaturnconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libsaturnkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Saturn Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Saturn Core would
