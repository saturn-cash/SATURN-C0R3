...
Saturn Core version 0.19.1 is now available from:

  <https://saturncore.org/bin/saturn-core-0.19.1/>
...
From Saturn Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Saturn Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Saturn Core does not yet change appearance when
...
- #17488 fix "saturnd already running" warnings on macOS (fanquake)
