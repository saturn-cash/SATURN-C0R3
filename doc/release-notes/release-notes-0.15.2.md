Saturn Core version *0.15.2* is now available from:

  <https://saturncore.org/bin/saturn-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in saturn-tx (TheBlueMatt)
