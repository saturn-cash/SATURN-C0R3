Saturn Core version 0.9.4 is now available from:

  https://saturn.org/bin/0.9.4/
...
this update is incompatible with the Saturn system and could lead to consensus
forks.

Saturn Core released binaries from https://saturn.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~saturn/+archive/ubuntu/saturn
- A third-party or self-compiled Saturn Core

upgrade to Saturn Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
