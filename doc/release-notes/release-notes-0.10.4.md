Saturn Core version 0.10.4 is now available from:

  <https://saturn.org/bin/saturn-core-0.10.4/>
...
- #6953 `43c2789` Split saturn-tx into its own package
- #6953 `dfe0d4d` Include saturn-tx binary on Debian/Ubuntu
