...
Assumeutxo is a feature that allows fast bootstrapping of a validating saturnd
instance.
...
```
$ saturn-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ saturn-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
